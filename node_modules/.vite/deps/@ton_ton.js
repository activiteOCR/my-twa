...
} from "./chunk-RSTHHCPE.js";
import "./chunk-4BZKTYO5.js";
...
var require_WalletV5BetaWalletId = __commonJS({
  "node_modules/@ton/ton/dist/wallets/v5beta/WalletV5BetaWalletId.js"(exports) {
    ...
    function loadWalletIdV5Beta(value) {
      ...
      const walletVersion = (_a = Object.entries(walletV5BetaVersionsSerialisation).find(([_, value2]) => value2 === walletVersionRaw)) == null ? void 0 : _a[0];
  ...
  "node_modules/@ton/ton/dist/wallets/v5beta/WalletContractV5Beta.js"(exports) {
    ...
    var WalletContractV5Beta = class _WalletContractV5Beta {
      static create(args) {
        var _a, _b, _c, _d;
        const walletId = {
          networkGlobalId: ((_a = args.walletId) == null ? void 0 : _a.networkGlobalId) ?? -239,
          workChain: ((_b = args == null ? void 0 : args.walletId) == null ? void 0 : _b.workChain) ?? 0,
          subwalletNumber: ((_c = args == null ? void 0 : args.walletId) == null ? void 0 : _c.subwalletNumber) ?? 0,
          walletVersion: ((_d = args == null ? void 0 : args.walletId) == null ? void 0 : _d.walletVersion) ?? "v5"
        };
  ...
  "node_modules/@ton/ton/dist/wallets/v5r1/WalletV5R1WalletId.js"(exports) {
    ...
    function loadWalletIdV5R1(value, networkGlobalId) {
      ...
      if (isClientContext) {
        ...
        const walletVersion = (_a = Object.entries(walletV5R1VersionsSerialisation).find(([_, value2]) => value2 === walletVersionRaw)) == null ? void 0 : _a[0];
        if (walletVersion === void 0) {
          throw new Error(`Can't deserialize walletId: unknown wallet version ${walletVersionRaw}`);
        }
        return {
  ...
  "node_modules/@ton/ton/dist/wallets/v5r1/WalletContractV5R1.js"(exports) {
    ...
    var WalletContractV5R1 = class _WalletContractV5R1 {
      static create(args) {
        ...
        if (((_a = args.walletId) == null ? void 0 : _a.context) && (0, WalletV5R1WalletId_1.isWalletIdV5R1ClientContext)(args.walletId.context) && args.walletId.context.workChain != void 0) {
          workChain = args.walletId.context.workChain;
        }
        return new _WalletContractV5R1(workChain, args.publicKey, {
          networkGlobalId: ((_b = args.walletId) == null ? void 0 : _b.networkGlobalId) ?? -239,
          context: ((_c = args.walletId) == null ? void 0 : _c.context) ?? {
            workChain: 0,
            walletVersion: "v5r1",
            subwalletNumber: 0
          }
